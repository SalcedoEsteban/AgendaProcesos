...
insert into termino (ter_id, ter_nombre, ter_numero_dias, ter_basico, tip_pro_id_pro) values (1, 'Perdida competencia', 365, true, 1);
insert into termino (ter_id, ter_nombre, ter_numero_dias, ter_basico, tip_pro_id_pro) values (2, 'admision', 30, true, 1);
insert into termino (ter_id, ter_nombre, ter_numero_dias, ter_basico, tip_pro_id_pro) values (3, 'indamision', 15, true, 1);
